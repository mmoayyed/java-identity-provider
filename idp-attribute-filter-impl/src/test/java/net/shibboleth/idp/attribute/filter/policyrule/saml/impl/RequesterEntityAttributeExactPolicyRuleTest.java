...
/**
 * test for {@link RequesterEntityAttributeExactPolicyRule}.
 */
...
public class RequesterEntityAttributeExactPolicyRuleTest extends BaseMetadataTests {
    ...
    private RequesterEntityAttributeExactPolicyRule getMatcher(String attributeName, String attributeValue,
            String attributeNameFormat, boolean ignoreUnmapped) throws ComponentInitializationException {
        RequesterEntityAttributeExactPolicyRule matcher = new RequesterEntityAttributeExactPolicyRule();
    ...
    @Test public void testFormat() throws ComponentInitializationException {
        ...
        RequesterEntityAttributeExactPolicyRule matcher =
