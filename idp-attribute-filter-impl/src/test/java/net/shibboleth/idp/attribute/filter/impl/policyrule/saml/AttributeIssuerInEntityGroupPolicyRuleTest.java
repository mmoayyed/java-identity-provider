...
public class AttributeIssuerInEntityGroupPolicyRuleTest extends BaseMetadataTests {
    ...
    @Test public void orphan() throws ComponentInitializationException {
        ...
        Assert.assertEquals(matcher.matches(metadataContext(idpEntity, orphan, "Principal")), Tristate.TRUE);
        Assert.assertEquals(matcher.matches(metadataContext(orphan, jiraEntity, "Principal")), Tristate.FAIL);
