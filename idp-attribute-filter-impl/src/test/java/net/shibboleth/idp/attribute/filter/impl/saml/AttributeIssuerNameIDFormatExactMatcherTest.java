...
/**
 * test for {@link AttributeIssuerNameIDFormatExactMatcher}.
 */
public class AttributeIssuerNameIDFormatExactMatcherTest extends BaseMetadataTests {
    
    private AttributeIssuerNameIDFormatExactMatcher getMatcher(String format) throws ComponentInitializationException {
        AttributeIssuerNameIDFormatExactMatcher matcher = new AttributeIssuerNameIDFormatExactMatcher();
    ...
    @Test public void simple() throws ComponentInitializationException, AttributeFilterException {
        AttributeIssuerNameIDFormatExactMatcher matcher = getMatcher("urn:oasis:names:tc:SAML:2.0:nameid-format:transient");
