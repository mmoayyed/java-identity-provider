...
/**
 * test for {@link IssuerInEntityGroupPolicyRule}.
 */
@SuppressWarnings("javadoc")
public class IssuerInEntityGroupPolicyRuleTest extends BaseMetadataTests {

    private IssuerInEntityGroupPolicyRule getMatcher(String group) throws ComponentInitializationException {
        IssuerInEntityGroupPolicyRule matcher = new IssuerInEntityGroupPolicyRule();
