...
/** tests for the {@link OutgoingMessageIssuerRegexCriterion}. */
public class TestOutgoingMessageIssuerRegex {
    ...
    public void incomingMessageIssuerCriterionTest() throws EvaluationException, ComponentInitializationException {
        ...
        OutgoingMessageIssuerRegexCriterion filter = new OutgoingMessageIssuerRegexCriterion();
        String pattern = TestContextContainer.IDP_ENTITY_ID.substring(2);
        ...
        filter = new OutgoingMessageIssuerRegexCriterion();
        pattern = TestContextContainer.IDP_ENTITY_ID.substring(0, 3) + ".*";
        filter.setRegularExpression(pattern);
        filter.initialize();
