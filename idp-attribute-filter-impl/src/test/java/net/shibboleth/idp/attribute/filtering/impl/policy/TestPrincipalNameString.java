...
public class TestPrincipalNameString {
    ...
    /**
     * Test principal name matching. Paramterization is tested in other tests.
     * 
    ...
    public void principalNameCriterionTest() throws EvaluationException, ComponentInitializationException {
        ...
        AttributePrincipalNameCriterion filter = new AttributePrincipalNameCriterion();
        ...
        filter = new AttributePrincipalNameCriterion();
