 ...
 */
public class RequesterInEntityGroupPolicyRule extends AbstractEntityGroupPolicyRule {

    /** Class logger. */
    @Nonnull private final Logger log = LoggerFactory.getLogger(RequesterInEntityGroupPolicyRule.class);
