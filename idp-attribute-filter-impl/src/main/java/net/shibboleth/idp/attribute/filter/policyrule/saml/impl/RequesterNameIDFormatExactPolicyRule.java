...
public class RequesterNameIDFormatExactPolicyRule extends AbstractNameIDFormatExactPolicyRule {

    /** Class logger. */
    @Nonnull private final Logger log = LoggerFactory.getLogger(RequesterNameIDFormatExactPolicyRule.class);
