 ...
 */
public class ProxiedRequesterInEntityGroupPolicyRule extends AbstractEntityGroupPolicyRule {

    /** Class logger. */
    @Nonnull private final Logger log = LoggerFactory.getLogger(ProxiedRequesterInEntityGroupPolicyRule.class);
    ...
    @Nullable protected EntityDescriptor getEntityMetadata(@Nonnull final AttributeFilterContext filterContext) {
        ...
        if (null == metadataContext) {
            log.debug("{} No proxied requester metadata found", getLogPrefix());
            return null;
        }
