...
public class AttributeIssuerNameIDFormatExactMatcher extends AbstractNameIDFormatSupportedMatcher {

    /** Logger. */
    private final Logger log = LoggerFactory.getLogger(AttributeIssuerNameIDFormatExactMatcher.class);
