...
/**
 * Implement the AtttibuteRequesterRegexPolicy activation criterion. <br />
 * If the entityID on the incoming message matches the provided regex then we return true.
 */
@ThreadSafe
public class IncomingMessageIssuerRegexCriterion extends BaseRegexCompare implements
