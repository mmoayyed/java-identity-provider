...
/**
 * A {@link Function} that extracts the {@link HttpServletResponse} from the {@link ExternalContext} of the given
 * {@link RequestContext}.
 */
public class WebflowRequestContextHttpServletResponseLookup implements
        Function<RequestContext, HttpServletResponse> {
