 ...
 *
 */
public class OutboundMessageIssuerPredicate extends BaseOutboundMessageContextPredicate {

    private Predicate<String> issuerMatch;

    public OutboundMessageIssuerPredicate(@Nonnull Predicate<String> issuerMatchingPredicate) {
