...
public class SourceValueBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {

    /** Schema type name. */
    public static final QName TYPE_NAME = new QName(AttributeDefinitionNamespaceHandler.NAMESPACE, "SourceValue");

    /** log. */
    private Logger log = LoggerFactory.getLogger(SourceValueBeanDefinitionParser.class);
