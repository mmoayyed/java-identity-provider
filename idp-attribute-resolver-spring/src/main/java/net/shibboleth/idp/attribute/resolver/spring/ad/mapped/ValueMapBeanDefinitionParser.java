...
public class ValueMapBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
    ...
    /** log. */
    private Logger log = LoggerFactory.getLogger(ValueMapBeanDefinitionParser.class);
    ...
    protected void doParse(Element config, ParserContext parserContext, BeanDefinitionBuilder builder) {
        ...
        final List<Element> sourceValueElements =
                ElementSupport.getChildElements(config, SourceValueBeanDefinitionParser.TYPE_NAME);
