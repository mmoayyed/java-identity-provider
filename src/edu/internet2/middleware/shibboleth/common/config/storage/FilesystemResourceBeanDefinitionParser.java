...
import edu.internet2.middleware.shibboleth.common.storage.FilesystemResource;
...
public class FilesystemResourceBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
    ...
    public static final QName ELEMENT_NAME = new QName(StorageNamespaceHandler.NAMESPACE, "FileSystemResource");
    
    /** Schema type name. */
    public static final QName TYPE_NAME = new QName(StorageNamespaceHandler.NAMESPACE, "FileSystemResourceType");
