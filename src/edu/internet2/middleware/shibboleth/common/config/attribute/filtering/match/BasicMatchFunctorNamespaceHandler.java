...
package edu.internet2.middleware.shibboleth.common.config.attribute.filtering.match;
...
public class BasicMatchFunctorNamespaceHandler extends BaseSpringNamespaceHandler {
    ...
    /** {@inheritDoc} */
    public void init() {
        registerBeanDefinitionParser(AnyMatchFunctorBeanDefinitionParser.TYPE_NAME,
