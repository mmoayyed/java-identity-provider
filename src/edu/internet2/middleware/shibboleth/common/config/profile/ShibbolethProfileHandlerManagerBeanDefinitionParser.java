...
/**
 * Spring bean definition parser for {@link ShibbolethProfileHandlerManager} services.
 */
public class ShibbolethProfileHandlerManagerBeanDefinitionParser extends AbstractReloadableServiceBeanDefinitionParser {

    /** Schema type. */
    public static final QName SCHEMA_TYPE = new QName(ProfileHandlerNamespaceHandler.NAMESPACE,
            "ShibbolethProfileHandlerManager");

    /** {@inheritDoc} */
    protected Class getBeanClass(Element arg0) {
        return ShibbolethProfileHandlerManager.class;
    }
}