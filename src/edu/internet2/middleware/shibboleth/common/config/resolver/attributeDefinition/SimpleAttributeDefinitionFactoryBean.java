 ...
 */
public class SimpleAttributeDefinitionFactoryBean implements FactoryBean {

    /** Attribute definition. */
    private SimpleAttributeDefinition attributeDefinition;
    
    /** Constructor. */
    public SimpleAttributeDefinitionFactoryBean() {
        attributeDefinition = new SimpleAttributeDefinition();
    }
