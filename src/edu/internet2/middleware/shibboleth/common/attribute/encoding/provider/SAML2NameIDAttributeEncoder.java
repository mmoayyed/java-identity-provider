 ...
 */
public class SAML2NameIDAttributeEncoder extends AbstractSAML2AttributeEncoder {

    /** Class logger. */
    private final Logger log = LoggerFactory.getLogger(SAML2NameIDAttributeEncoder.class);
    ...
    /** Constructor. */
    public SAML2NameIDAttributeEncoder() {
        super();
