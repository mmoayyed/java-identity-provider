...
/**
 * A match function that evaluates to true if {@link SAMLFilterContext#getIssuerMetadata()} matches the
...
public class AttributeIssuerInEntityGroupMatchFunctor extends AbstractEntityGroupMatchFunctor {
    ...
    public boolean evaluate(ShibbolethFilteringContext filterContext) throws FilterProcessingException {
        return isEntityInGroup(filterContext.getAttribtueRequestContext().getAttributeIssuerMetadata());
    }
