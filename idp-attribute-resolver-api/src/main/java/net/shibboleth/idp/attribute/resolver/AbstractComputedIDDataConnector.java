 ...
 */
public abstract class AbstractComputedIDDataConnector extends AbstractDataConnector {

    /** Class logger. */
    private final Logger log = LoggerFactory.getLogger(AbstractComputedIDDataConnector.class);
