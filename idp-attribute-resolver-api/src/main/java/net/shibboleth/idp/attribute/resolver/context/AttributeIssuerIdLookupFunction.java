 ...
 * </p>
 */
public class AttributeIssuerIdLookupFunction implements Function<ProfileRequestContext, String> {
    ...
    /** Constructor. */
    public AttributeIssuerIdLookupFunction() {
        attributeResolutionContextLookupStrategy =
    ...
    @Override @Nullable public String apply(@Nullable final ProfileRequestContext input) {
        if (input != null) {
            ...
            if (arc != null) {
                return arc.getAttributeIssuerID();
            }
        }
