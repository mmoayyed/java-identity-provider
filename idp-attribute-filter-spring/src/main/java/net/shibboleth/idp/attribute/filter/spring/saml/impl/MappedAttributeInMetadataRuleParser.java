...
/**
 * Bean definition parser for deprecated variant of {@link AttributeInMetadataMatcher}.
 */
public class MappedAttributeInMetadataRuleParser extends AttributeInMetadataRuleParser {
    ...
    @Override protected void doNativeParse(@Nonnull final Element config, @Nonnull final ParserContext parserContext,
        ...
        super.doNativeParse(config, parserContext, builder);
    }
