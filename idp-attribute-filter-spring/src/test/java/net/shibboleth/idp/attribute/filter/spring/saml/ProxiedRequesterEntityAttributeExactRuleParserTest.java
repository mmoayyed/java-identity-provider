...
/**
 * test for {@link ProxiedRequesterEntityAttributeExactPolicyRule}.
 */
public class ProxiedRequesterEntityAttributeExactRuleParserTest extends BaseAttributeFilterParserTest {
    ...
    @Test public void basic() throws ComponentInitializationException {
        ProxiedRequesterEntityAttributeExactPolicyRule rule =
                (ProxiedRequesterEntityAttributeExactPolicyRule) getPolicyRule("proxiedrequesterEA2.xml");
