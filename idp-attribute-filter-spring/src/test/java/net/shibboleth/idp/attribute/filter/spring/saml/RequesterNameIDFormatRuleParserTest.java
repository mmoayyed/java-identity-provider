...
/**
 * test for {@link RequesterNameIDFormatRuleParser}.
 */
public class RequesterNameIDFormatRuleParserTest extends BaseAttributeFilterParserTest {
    ...
    @Test public void basic() throws ComponentInitializationException {
        final RequesterNameIDFormatExactPolicyRule rule =
                (RequesterNameIDFormatExactPolicyRule) getPolicyRule("requesterNameId2.xml");
