...
/**
 * test for {@link RequesterRegistrationAuthorityPolicyRule}.
 */
...
public class RequesterRegistrationAuthorityRuleParserTest extends BaseAttributeFilterParserTest {
    ...
    @Test public void silentTrue() throws ComponentInitializationException {
        final RequesterRegistrationAuthorityPolicyRule rule =
                (RequesterRegistrationAuthorityPolicyRule) getPolicyRule("registrationAuthorityOne.xml");
    ...
    @Test public void silentFalse() throws ComponentInitializationException {
        final RequesterRegistrationAuthorityPolicyRule rule
        = (RequesterRegistrationAuthorityPolicyRule) getPolicyRule("registrationAuthorityTwo.xml");
