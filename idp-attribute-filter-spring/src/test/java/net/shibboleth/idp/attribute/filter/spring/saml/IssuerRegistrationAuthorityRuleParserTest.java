...
import net.shibboleth.idp.attribute.filter.policyrule.saml.impl.IssuerRegistrationAuthorityPolicyRule;
...
/**
 * test for {@link IssuerRegistrationAuthorityRuleParser}.
 */
@SuppressWarnings("javadoc")
public class IssuerRegistrationAuthorityRuleParserTest extends BaseAttributeFilterParserTest {


    @Test public void silentTrue() throws ComponentInitializationException {
        final IssuerRegistrationAuthorityPolicyRule rule =
                (IssuerRegistrationAuthorityPolicyRule) getPolicyRule("issuerAuthorityOne.xml");
    ...
    @Test public void silentFalse() throws ComponentInitializationException {
        final IssuerRegistrationAuthorityPolicyRule rule
        = (IssuerRegistrationAuthorityPolicyRule) getPolicyRule("issuerAuthorityTwo.xml");
