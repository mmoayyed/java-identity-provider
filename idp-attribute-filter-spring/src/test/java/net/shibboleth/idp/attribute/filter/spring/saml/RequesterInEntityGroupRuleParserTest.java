...
import net.shibboleth.idp.attribute.filter.policyrule.saml.impl.RequesterInEntityGroupPolicyRule;
...
/**
 * test for {@link RequesterInEntityGroupRuleParser}.
 */
@SuppressWarnings("javadoc")
public class RequesterInEntityGroupRuleParserTest extends  BaseAttributeFilterParserTest {

    private void testRule(final String propValue, final boolean result) throws ComponentInitializationException {
        final RequesterInEntityGroupPolicyRule rule = (RequesterInEntityGroupPolicyRule) getPolicyRule("requesterEG2.xml", contextWithPropertyValue(propValue));
