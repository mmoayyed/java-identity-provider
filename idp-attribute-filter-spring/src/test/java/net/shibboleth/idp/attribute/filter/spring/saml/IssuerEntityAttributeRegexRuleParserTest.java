 ...
 */
public class IssuerEntityAttributeRegexRuleParserTest extends  BaseAttributeFilterParserTest {

    @SuppressWarnings("javadoc") @Test public void basic() throws ComponentInitializationException {
        final IssuerEntityAttributeRegexPolicyRule rule = (IssuerEntityAttributeRegexPolicyRule) getPolicyRule("issuerEARegex2.xml");
