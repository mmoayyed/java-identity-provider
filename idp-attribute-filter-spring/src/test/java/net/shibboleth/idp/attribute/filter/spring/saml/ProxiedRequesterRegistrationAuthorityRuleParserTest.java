...
import net.shibboleth.idp.attribute.filter.policyrule.saml.impl.ProxiedRequesterRegistrationAuthorityPolicyRule;
import net.shibboleth.idp.attribute.filter.spring.testing.BaseAttributeFilterParserTest;
import net.shibboleth.utilities.java.support.component.ComponentInitializationException;

/**
 * test for {@link ProxiedRequesterRegistrationAuthorityPolicyRule}.
 */
@SuppressWarnings("javadoc")
public class ProxiedRequesterRegistrationAuthorityRuleParserTest extends BaseAttributeFilterParserTest {


    @Test public void silentTrue() throws ComponentInitializationException {
        final ProxiedRequesterRegistrationAuthorityPolicyRule rule =
                (ProxiedRequesterRegistrationAuthorityPolicyRule) getPolicyRule("proxiedregistrationAuthorityOne.xml");
    ...
    @Test public void silentFalse() throws ComponentInitializationException {
        final ProxiedRequesterRegistrationAuthorityPolicyRule rule
        = (ProxiedRequesterRegistrationAuthorityPolicyRule) getPolicyRule("proxiedregistrationAuthorityTwo.xml");
