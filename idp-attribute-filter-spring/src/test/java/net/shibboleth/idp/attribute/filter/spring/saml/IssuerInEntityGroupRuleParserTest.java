...
import net.shibboleth.idp.attribute.filter.policyrule.saml.impl.IssuerInEntityGroupPolicyRule;
...
/**
 * test for {@link IssuerInEntityGroupRuleParser}.
 */
@SuppressWarnings("javadoc")
public class IssuerInEntityGroupRuleParserTest extends  BaseAttributeFilterParserTest {

    private void testRule(final String propValue, final boolean result) throws ComponentInitializationException {
        final IssuerInEntityGroupPolicyRule rule = (IssuerInEntityGroupPolicyRule) getPolicyRule("issuerEG2.xml", contextWithPropertyValue(propValue));
