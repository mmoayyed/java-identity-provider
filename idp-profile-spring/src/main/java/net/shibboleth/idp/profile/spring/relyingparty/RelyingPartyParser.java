 ...
 * TODO.
 */
public class RelyingPartyParser extends AbstractSingleBeanDefinitionParser {

    /** Element name. */
    public static final QName ELEMENT_NAME = new QName(RelyingPartyNamespaceHandler.NAMESPACE, "RelyingParty");

    /** {@inheritDoc} */
    @Override protected Class<RelyingPartyConfiguration> getBeanClass(Element element) {
