 ...
 */
public class X509InlineParserTest extends AbstractCredentialParserTest {

    @Test public void certOnly() throws IOException {
        final BasicX509Credential credential =
                (BasicX509Credential) getBean(Credential.class, true, "inlineCertOnly.xml");
    ...
    @Test(expectedExceptions={BeanCreationException.class,}) public void wrongCert() throws IOException {
        getBean(Credential.class, true, "inlineWrongCert.xml");
    }
    
    @Test public void certKeyCrl() throws IOException {
        final BasicX509Credential credential =
                (BasicX509Credential) getBean(Credential.class, true, "inlineKeyCertCrl.xml");
