 ...
 */
public class X509FilesystemParserTest extends AbstractCredentialParserTest {

    @Test public void certOnly() throws IOException {
        final BasicX509Credential credential =
                (BasicX509Credential) getBean(Credential.class, true, "fileCertOnly.xml");
    ...
    @Test(expectedExceptions={BeanCreationException.class,}) public void twoCert() throws IOException {
        getBean(Credential.class, true, "fileTwoCert.xml");
    }

    @Test(expectedExceptions={BeanCreationException.class,}) public void wrongCert() throws IOException {
        getBean(Credential.class, true, "fileWrongCert.xml");
    }
    
    @Test public void certKeyCrl() throws IOException {
        final BasicX509Credential credential =
                (BasicX509Credential) getBean(Credential.class, true, "fileKeyCertCrl.xml");
    ...
    @Test public void certElementsKeyNames() throws IOException {
        final BasicX509Credential credential =
                (BasicX509Credential) getBean(Credential.class, true, "fileCertElementsKeyName.xml");
