...
/** Factory that produces {@link IdpInitatedSsoRequest} message decoders. */
public class IdpInitiatedSsoDecoderFactory implements HttpServletRequestMessageDecoderFactory<IdpInitatedSsoRequest> {
    ...
    private class IdpInitiatedSsoRequestMessageDecoder extends
     ...
     */
    @ThreadSafe
    public static class IdpInitatedSsoRequest {
