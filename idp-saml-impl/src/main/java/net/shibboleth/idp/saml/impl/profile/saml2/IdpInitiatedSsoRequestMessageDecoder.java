...
class IdpInitiatedSsoRequestMessageDecoder extends BaseIdpInitiatedSsoRequestMessageDecoder<AuthnRequest> {
    ...
    protected void doDecode() throws MessageDecodingException {
        ...
        authnRequest.setIssueInstant(new DateTime(getTime(getHttpServletRequest()), ISOChronology.getInstanceUTC()));
