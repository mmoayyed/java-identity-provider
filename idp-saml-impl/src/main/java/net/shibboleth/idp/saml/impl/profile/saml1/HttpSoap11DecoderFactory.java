...
/** Factory used to produce {@link HTTPSOAP11Decoder} message decoders. */
@ThreadSafe
public class HttpSoap11DecoderFactory implements HttpServletRequestMessageDecoderFactory {
     ...
     */
    public HttpSoap11DecoderFactory(@Nonnull final ParserPool pool) {
