...
/** {@link AuditExtractorFunction} that returns the InResponseTo attribute from a response. */
public class InResponseToAuditExtractor implements AuditExtractorFunction {
