...
/** {@link AuditExtractorFunction} that returns the ID attribute from the assertions in a response. */
public class AssertionIDAuditExtractor implements AuditExtractorFunction {
