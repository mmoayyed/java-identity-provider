...
/** {@link AuditExtractorFunction} that returns the first authentication timestamp from an assertions in a response. */
public class AuthnInstantAuditExtractor implements AuditExtractorFunction {
