...
public class StringAttributeValuePredicateTest {
    ...
    @Test public void stringAttributeValueMatches() {
        ...
        Assert.assertTrue(pred.apply(new StringAttributeValue(VALUE_ONE)));
        Assert.assertFalse(pred.apply(new StringAttributeValue(VALUE_TWO)));
        Assert.assertTrue(pred.apply(new ScopedStringAttributeValue(VALUE_ONE, VALUE_TWO)));
        Assert.assertFalse(pred.apply(new ScopedStringAttributeValue(VALUE_TWO, VALUE_ONE)));
    }
}
