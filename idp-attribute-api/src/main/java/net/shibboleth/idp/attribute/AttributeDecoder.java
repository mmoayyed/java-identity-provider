...
public interface AttributeDecoder<DecodedType> {
     ...
     */
    @Nonnull @NotEmpty public String getDecodedAttributeId();
     ...
     * 
     * @return the attribute containing the decoded information
     * 
     * @throws AttributeDecodingException thrown if there was a problem decoding the given information
     */
    @Nonnull public Attribute decode(@Nonnull DecodedType data) throws AttributeDecodingException;
}