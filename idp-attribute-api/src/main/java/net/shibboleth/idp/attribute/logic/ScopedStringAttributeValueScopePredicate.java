...
/**
 * A predicate that supports the evaluation of a {@link Predicate} that supports {@link String} objects against
 * {@link ScopedStringAttributeValue} scope value.
 */
public class ScopedStringAttributeValueScopePredicate implements Predicate {
