...
/**
 * Predicate to determine whether per-attribute consent is enabled.
 */
public class EnablePerAttributeConsentPredicate implements Predicate<ProfileRequestContext> {

    /** Class logger. */
    @Nonnull private final Logger log = LoggerFactory.getLogger(EnablePerAttributeConsentPredicate.class);
    ...
    /** Constructor. */
    public EnablePerAttributeConsentPredicate() {
    ...
    public boolean apply(@Nullable final ProfileRequestContext input) {
        ...
        return ((AttributeConsentFlowDescriptor) interceptorFlowDescriptor).enablePerAttributeConsent();
    }
