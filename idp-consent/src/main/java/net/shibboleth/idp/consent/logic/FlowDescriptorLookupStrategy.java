 ...
 */
// TODO tests
public class FlowDescriptorLookupStrategy<T extends ProfileInterceptorFlowDescriptor> implements
    ...
    /** Constructor. */
    public FlowDescriptorLookupStrategy() {
    ...
    @Nullable public T apply(ProfileRequestContext input) {
        ...
        if (!(interceptorFlowDescriptor instanceof ConsentFlowDescriptor)) {
            return null;
        }
