...
import net.shibboleth.idp.consent.storage.CollectionSerializer;
...
public class AbstractConsentIndexedStorageAction extends AbstractConsentStorageAction {
     ...
     * {@link net.shibboleth.idp.consent.flow.ConsentFlowDescriptor#getMaximumNumberOfStoredRecords()} so that a new
     * record may be stored.
     * 
     * Storage records will be pruned if
     * {@link net.shibboleth.idp.consent.flow.ConsentFlowDescriptor#getMaximumNumberOfStoredRecords()} is greater than
     * zero.
     * 
     ...
     * {@link net.shibboleth.idp.consent.flow.ConsentFlowDescriptor#getMaximumNumberOfStoredRecords()}.
     * 
     * @param profileRequestContext the profile request context
     * @param result the profile interceptor result to be stored
     * @throws IOException if an error occurs
