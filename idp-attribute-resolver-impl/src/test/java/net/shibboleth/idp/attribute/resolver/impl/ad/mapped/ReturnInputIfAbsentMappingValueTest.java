...
/** test for {@link ReturnInputIfAbsentMappingValue}. */
public class ReturnInputIfAbsentMappingValueTest {
    ...
    try {
        new ReturnInputIfAbsentMappingValue(null);
...
@Test public void TestApply() {
    ValueMapping map = new ReturnInputIfAbsentMappingValue(TEST_MAPPER);
    try {
        map.apply(null);
    ...
    Assert.assertEquals(map.apply(DOESNT_MATCH).get(), DOESNT_MATCH);
}
}
