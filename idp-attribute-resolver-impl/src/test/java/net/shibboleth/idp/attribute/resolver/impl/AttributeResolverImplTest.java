...
public class AttributeResolverImplTest {
    ...
    @Test public void setAttributeDefinitions() throws Exception {
        ...
        final AttributeResolverImpl resolver = newAttributeResolverImpl(" foo ", definitions, null, null);
        resolver.initialize();
        ...
        definitions.add(new MockAttributeDefinition("foo", new IdPAttribute("test")));
        try {
            newAttributeResolverImpl(" foo ", definitions, null, null);
            Assert.fail();
    ...
    @Test public void setDataConnectors() throws Exception {
        ...
        final AttributeResolver resolver = newAttributeResolverImpl("foo", null, connectors, null);
        Assert.assertNotNull(resolver.getDataConnectors());
        Assert.assertEquals(resolver.getDataConnectors().size(), 2);

        connectors.add(new MockDataConnector("foo", (Map) null));
        try {
            newAttributeResolverImpl(" foo ", null, connectors, null);
            Assert.fail();
        } catch (final IllegalArgumentException e) {
            // OK
        }
    ...
    @Test public void resolveWithDependenciesOld() throws Exception {
        ...
        final ResolverPluginDependency dep2 = new ResolverPluginDependency("ad1");
        final ResolverPluginDependency dep3 = new ResolverPluginDependency("ad2");
        ...
        final AttributeResolverImpl resolver = newAttributeResolverImpl("foo", definitions, connectors, null);
        resolver.initialize();
    ...
    @Test(enabled=true) public void resolveWithTimeout() throws Exception {
        ...
        final AttributeResolverImpl resolver = newAttributeResolverImpl("foo", Collections.singleton((AttributeDefinition)ad), connectors, null);
        resolver.initialize();
    ...
    @Test public void cachedDataConnectorDependency() throws ComponentInitializationException, ResolutionException {
        ...
        AttributeResolverImpl resolver = newAttributeResolverImpl("foo", definitions, connectors, null);
        resolver.initialize();
        ...
        resolver = newAttributeResolverImpl("failoverTest", definitions, connectors, null);
        resolver.initialize();
    ...
    @Test public void badPluginIdInitializeOld() throws Exception {
        ...
        final ResolverPluginDependency dep3 = new ResolverPluginDependency("ad0");
        ad0 = new MockAttributeDefinition("ad0", new IdPAttribute("test"));
        ad0.setDependencies(Collections.singleton(dep3));
        definitions = new LazySet<>();
        definitions.add(ad0);
    ...
    @Test public void circularDependencyInitializeOld() throws Exception {
        ...
        final MockDataConnector dc1 = new MockDataConnector("dc1", null, Collections.singleton(new ResolverPluginDependency("ad0")));
        ...
        resolver = newAttributeResolverImpl("foo", definitions, connectors, null);
        try {
            resolver.initialize();
            Assert.fail("invalid resolver configuration didn't fail initialization");
        } catch (final ComponentInitializationException e) {
